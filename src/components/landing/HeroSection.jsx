    ...
    return (
        <section id="inicio" className="relative px-6 pt-28 pb-20 text-center">
            ...
            <div className="mx-auto max-w-4xl">
                ...
                <div className="mx-auto mt-6 max-w-2xl rounded-2xl border border-emerald-400/30 bg-emerald-500/10 px-5 py-4 text-sm font-semibold text-emerald-100">
                    Acceso gratuito durante el lanzamiento hasta el 1 de septiembre de 2026.
                    Sin tarjeta. Sin compromiso.
                </div>

                <button
                    onClick={() => navigate("/register")}
                    className="mt-8 inline-flex cursor-pointer items-center gap-2 rounded-full bg-gradient-to-r from-[#199462] to-[#2D7A5F] px-8 py-4 text-lg font-bold text-white shadow-lg shadow-emerald-500/20 transition hover:scale-105"
                >
                ...
                <p className="mt-4 text-sm text-white/55">
                    Ideal para barberías, peluquerías, uñas, estética y negocios con turnos.
                </p>
